...
// Inline snippet creates window.Cal as a queue collector immediately,
// then embed.js processes the queue and wires up data-cal-link event delegation.
const CAL_SNIPPET = `
(function (C, A, L) {
...
export default function MoiPage() {
    ...
    return (
        <>
            {/* Cal embed — loads embed.js and sets up click delegation for data-cal-link */}
            <Script
                id="cal-embed"
            ...
            <div className="min-h-screen flex flex-col items-center pt-1 md:pt-6 pb-12 px-4 md:px-6"
                ...
                <main className="w-full max-w-[640px] mt-4 md:mt-8 flex flex-col gap-3 md:gap-4">
                    ...
                    {/* CONTAINER 2: WORK WITH ME — data-cal-link triggers Cal's native popup */}
                    <button
